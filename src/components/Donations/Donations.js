      ...
      <div className="donations-container">
        ...
        <div className="donations-content">
          ...
          <p className="donations-text">
            Thank You makes it easy to support causes important to you. Select
            an organization and with each gift you send, Thank You will match
            proceeds up to $1 (Donations will be kept anon)
          </p>
          <img
