      ...
      <div className="why-container">
        <div className="why-content">
          ...
          <p className="why-text">
            ...
            shopping can lead a surge in price for popular items, not to mention
            the rush shipping fees. On top of that its also hard to keep track
            of what kids like these days. <br />
            Thats where our personal curator can help. Our team of professional
            gift givers will help ensure you pick out the best gift possible.
          </p>
        </div>
        {isTablet ? (
          <>
