                  ...
                  <div className="team-roster">
                    {data.getTeam.roster.map((player) => (
                      <Query
                        ...
                        variables={{ ids: [player.thumbnail] }}
                      >
                        {({ loading, error, data }) => {
                          ...
                          return (
                            <Card
                              ...
                              hoverable
                              onClick={() =>
                                this.handlePlayerClick(player.id, player.name)
                              }
                            >
                              <Meta
                                title={player.name}
                                avatar={
                                  <Avatar src="https://res-1.cloudinary.com/hireclub/image/upload/c_fill,f_auto,g_north,h_200,q_auto,w_200/nlpxwm4loty0zh77b7hn" />
                                }
                              />
                            </Card>
                          );
